...
### Typography
→ *Consult [typography reference](typography.md) for scales, pairing, and loading strategies.*
...
### Color & Theme
→ *Consult [color reference](color-and-contrast.md) for OKLCH, palettes, and dark mode.*
...
### Layout & Space
→ *Consult [spatial reference](spatial-design.md) for grids, rhythm, and container queries.*
